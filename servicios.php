                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        <ul class="nav nav-tabs">
                            <li class="active" ><a href="#servicioCcita" tipoS="1"  data-toggle="tab">Servicios con Cita</a></li>
						<?php
							if  ($_SESSION["idRol"] =='0' || $_SESSION["idRol"] =='1'){
							   echo'<li><a href="#serviciosActivos" tipoS="2" data-toggle="tab"  >Servicios Activos</a></li>';
							}
						?>	
														
							<li><a href="#serviciosFinalizados" tipoS="3" data-toggle="tab"  >Servicios Finalizados</a></li>
                        </ul>
                    </div>
                </div>
                <div class="panel-body">
                    <div class="tab-content" >
                        <div class="tab-pane active" id="servicioCcita"> 
						<?php
						if  ($_SESSION["idRol"] != '0' &&  $_SESSION["idRol"] != '1')
							echo '
								<button class="btn btn-primary btn-icon icon-left" style="top:-4px;margin-left:80%" type="button" id="btnAddServicio">
										 <i class="entypo-list-add"></i> Agregar Servicio
								</button>';	
							?>								
                            <table class="table table-bordered datatable" id="tblServiciosConCita">
                                    <thead>
                                        <tr>
										    <th>#</th>
                                            <th>Cliente</th>
				   		...
				   		<div class="tab-pane" id="serviciosActivos"> 
						...
						<div class="tab-pane" id="serviciosFinalizados"> 
                            <table class="table table-bordered datatable" id="tblServiciosFinalizados">
                                    <thead>
                                        <tr>
										    <th>#</th>
                                            <th>Cliente</th>
                                    ...
                                    <tbody id="bodyServiciosFinalizados">
                                    </tbody>
                                     <tfoot>
                                        <tr>
										    <th>#</th>
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                            <div class="form-group">
									...
									placeholder="Descripcion del vehiculo" data-validate="" 
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="placas" name="placas"
									   data-validate="" data-message-required="Porfavor especifique la placa del vehiculo." 
									   placeholder="Placas" >
                            </div>
                        </div>						
                    </div>
                    <div class="row">
						<div class="col-md-12">
                            <div class="form-group">
								...
								data-message-required="Por favor especifique el origen del servicio" >
					...
					<div class="row">
                         <div class="col-md-12">
                            <div class="form-group">
									...
									data-message-required="Por favor especifique el destino del servicio" />
									<span style="color: blue; font-size: 11px; padding: 3px;">Formato de búsqueda: calle, número, colonia, ciudad y estado.</span>
                            </div>
                        </div>
					</div>
