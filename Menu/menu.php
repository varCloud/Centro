...
<div class="sidebar-menu">
    <div class="sidebar-menu-inner">
        <header class="logo-env">
            ...
            <div class="logo"><a href="index.php">
                <img src="Imgs/logo_chico.png" width="120" alt="" />
            </a></div>
            <!-- logo collapse icon -->
    ...
    <ul id="main-menu" class="main-menu">
		...
		<?php
		if  ($_SESSION["idRol"] == '3')// PARA EL ROL DE EJECUTIVOS
			echo '<li class="has-sub"><a href="citas.php"><i class="entypo-book"></i><span class="title">Citas Servicios Automotrices</span></a></li>
				  <li class="has-sub"><a href="servicios.php"><i class="entypo-book-open"></i><span class="title">Servicios Traslados</span></a></li>
				  <li class="has-sub"><a href="serviciosActivos.php"><i class="entypo-book"></i><span class="title">Servicios Traslados Activos</span></a></li>
			<!--	<li class="has-sub"><a href="choferes.php"><i class="entypo-users"></i><span class="title">Choferes</span></a></li>-->
			<!--	<li class="has-sub"><a href="clientes.php"><i class="entypo-users"></i><span class="title">Clientes</span></a></li>-->';
		else if ($_SESSION["idRol"] == '2') // PARA EL ROL DE SUPERVISOR
		{
			echo '
			...
			<!--<li class="has-sub"><a href="choferes.php"><i class="entypo-users"></i><span class="title">Choferes</span></a></li>
			<li class="has-sub"><a href="clientes.php"><i class="entypo-users"></i><span class="title">Clientes</span></a></li>-->
			<li class="has-sub"><a href="usuarios.php"><i class="entypo-users"></i><span class="title">Usuarios</span></a></li>';
		}else  //PARA EL ROL ADMINISTRATIVO
		{
			...
			<li class="has-sub"><a href="clientes.php"><i class="entypo-users"></i><span class="title">Clientes</span></a></li>
			<li class="has-sub"><a href="usuarios.php"><i class="entypo-users"></i><span class="title">Usuarios</span></a></li>
			<li class="has-sub"><a href="estadisticos.php"><i class="entypo-book"></i><span class="title">Reportes</span></a></li>';
		}
       ?>

    </ul>
                    <!--
    <li class="has-sub"><a href="dashboard/main/index.html"><i class="entypo-gauge"></i><span class="title">Dashboard</span></a></li>
    </ul>
                        <ul>
                    ...
                    <li class="has-sub"><a href="layouts/layout-api/index.html"><i class="entypo-layout"></i><span class="title">Layouts</span></a>
                        <ul>
                            <li><a href="layouts/layout-api/index.html"><span class="title">Layout API</span></a> </li>
                            <li><a href="layouts/collapsed-sidebar/index.html"><span class="title">Collapsed Sidebar</span></a> </li>
                            ...
                            <li><a href="layouts/horizontal-menu-boxed/index.html"><span class="title">Horizontal Menu Boxed</span></a> </li>
                            <li><a href="layouts/horizontal-menu-fluid/index.html"><span class="title">Horizontal Menu Fluid</span></a> </li>
                            ...
                            <li><a href="layouts/both-menus-right-sidebar/index.html"><span class="title">Both Menus (Right Sidebar)</span></a> </li>
                            <li class="has-sub"><a href="layouts/page-transition-fade/index.html"><span class="title">Page Enter Transitions</span></a>
                                <ul>
                                    <li><a href="layouts/page-transition-fade/index.html"><span class="title">Fade Scale</span></a> </li>
                                    <li><a href="layouts/page-transition-left-in/index.html"><span class="title">Left In</span></a> </li>
                                    <li><a href="layouts/page-transition-right-in/index.html"><span class="title">Right In</span></a> </li>
                                    <li><a href="layouts/page-transition-fade-only/index.html"><span class="title">Fade Only</span></a> </li>
                                </ul>
                            </li>
                            <li><a href="layouts/boxed/index.html"><span class="title">Boxed Layout</span></a> </li>
                        </ul>
                    </li>
                    <li><a href="frontend/main/index.html" target="_blank"><i class="entypo-monitor"></i><span class="title">Frontend</span></a> </li>
                    <li class="has-sub"><a href="ui/panels/index.html"><i class="entypo-newspaper"></i><span class="title">UI Elements</span></a>
                        <ul>
                            ...
                            <li><a href="ui/tabs-accordions/index.html"><span class="title">Tabs &amp; Accordions</span></a> </li>
                            <li><a href="ui/tooltips-popovers/index.html"><span class="title">Tooltips &amp; Popovers</span></a> </li>
                            ...
                            <li><a href="ui/badges-label/s.html"><span class="title">Badges &amp; Labels</span></a> </li>
                            <li><a href="ui/progress-bars/index.html"><span class="title">Progress Bars</span></a> </li>
                    ...
                    <li class="has-sub"><a href="mailbox/main/index.html"><i class="entypo-mail"></i><span class="title">Mailbox</span><span class="badge badge-secondary">8</span></a>
                        <ul>
                            <li><a href="mailbox/main/index.html"><i class="entypo-inbox"></i><span class="title">Inbox</span></a> </li>
                            <li><a href="mailbox/compose/index.html"><i class="entypo-pencil"></i><span class="title">Compose Message</span></a> </li>
                            <li><a href="mailbox/message/index.html"><i class="entypo-attach"></i><span class="title">View Message</span></a> </li>
                        </ul>
                    </li>
                    <li class="has-sub"><a href="forms/main/index.html"><i class="entypo-doc-text"></i><span class="title">Forms</span></a>
                        <ul>
                            <li><a href="forms/main/index.html"><span class="title">Basic Elements</span></a> </li>
                            <li><a href="forms/advanced/index.html"><span class="title">Advanced Plugins</span></a> </li>
                            <li><a href="forms/wizard/index.html"><span class="title">Form Wizard</span></a> </li>
                            <li><a href="forms/validation/index.html"><span class="title">Data Validation</span></a> </li>
                    ...
                    <li class="has-sub"><a href="tables/main/index.html"><i class="entypo-window"></i><span class="title">Tables</span></a>
                        <ul>
                    ...
                    <li class="has-sub"><a href="extra/icons/index.html"><i class="entypo-bag"></i><span class="title">Extra</span><span class="badge badge-info badge-roundless">New Items</span></a>
                        <ul>
                            ...
                            <li class="has-sub"><a href="extra/google-maps/index.html"><span class="title">Maps</span></a>
                                <ul>
                                    <li><a href="extra/google-maps/index.html"><span class="title">Google Maps</span></a> </li>
                                    <li><a href="extra/vector-maps/index.html"><span class="title">Vector Maps</span></a> </li>
                                </ul>
                            </li>
                            ...
                            <li><a href="extra/calendar-2/index.html"><span class="title">Calendar 2</span><span class="badge badge-secondary badge-roundless">New</span></a> </li>
                            ...
                            <li class="has-sub"><a href="extra/gallery/index.html"><span class="title">Gallery</span></a>
                                <ul>
                                    <li><a href="extra/gallery/index.html"><span class="title">Albums</span></a> </li>
                                    <li><a href="extra/gallery-single/index.html"><span class="title">Single Album</span></a> </li>
                                </ul>
                            </li>
                            ...
                            <li><a href="extra/timeline-centered/index.html"><span class="title">Timeline Centered</span></a> </li>
                            <li><a href="extra/tocify/index.html"><span class="title">Tocify</span></a> </li>
                            <li><a href="ui/notifications/index.html"><span class="title">Notifications</span></a> </li>
                            ...
                            <li><a href="extra/language-selector/index.html"><span class="title">Language Selector</span></a> </li>
                            ...
                            <li><a href="extra/load-progress/index.html"><span class="title">Load Progress</span></a> </li>
                        </ul>
                    </li>
                    ...
                    <li class="has-sub"><a href="index.html#"><i class="entypo-flow-tree"></i><span class="title">Menu Levels</span></a>
                        <ul>
                            <li><a href="index.html#"><i class="entypo-flow-line"></i><span class="title">Menu Level 1.1</span></a> </li>
                            <li><a href="index.html#"><i class="entypo-flow-line"></i><span class="title">Menu Level 1.2</span></a> </li>
                            <li class="has-sub"><a href="index.html#"><i class="entypo-flow-line"></i><span class="title">Menu Level 1.3</span></a>
                                <ul>
                                    <li><a href="index.html#"><i class="entypo-flow-parallel"></i><span class="title">Menu Level 2.1</span></a> </li>
                                    <li class="has-sub"><a href="index.html#"><i class="entypo-flow-parallel"></i><span class="title">Menu Level 2.2</span></a>
                                        <ul>
                                            <li class="has-sub"><a href="index.html#"><i class="entypo-flow-cascade"></i><span class="title">Menu Level 3.1</span></a>
                                                <ul>
                                                    <li><a href="index.html#"><i class="entypo-flow-branch"></i><span class="title">Menu Level 4.1</span></a> </li>
                                                </ul>
                                            </li>
                                            <li><a href="index.html#"><i class="entypo-flow-cascade"></i><span class="title">Menu Level 3.2</span></a> </li>
                                        </ul>
                                    </li>
                                    <li><a href="index.html#"><i class="entypo-flow-parallel"></i><span class="title">Menu Level 2.3</span></a> </li>
                                </ul>
                            </li>
                        </ul>
                    </li>
		 ...
		 <div id="loader" class="loadDalton" style="display:none">
			 <div class="loaderDalton">
				 <div class="inner one"></div>
				 <div class="inner two"></div>
				 <div class="inner three"></div>
			 </div>
			<div class="loader-leyenda">
				 <p id="labelLoader"  > Cargando</p>
				<!-- <div class="tableLoad">
					 <div class="cellLoad" style="width:auto;">
