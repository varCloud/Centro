				...
				*/
				...
				setTimeout(function()
				{
					...
					$.ajax({
						...
						error: function()
						{
							alert("Ocurrio un error espere un momento y vuleva a intentarlo porfavor");
						},
						success: function(response)
						{
							...
							setTimeout(function()
							{
								...
								if(login_status == 'Error al intentar Iniciar Sesion')
								{
								...
								if(login_status == 'success')
								{
									...
									setTimeout(function()
									{
										var redirect_url = 'index.php';
											if(response.idRol == "2" || response.idRol == "3")
